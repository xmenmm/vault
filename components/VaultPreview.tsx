// A glassy preview of the actual vault, used as the landing hero — shows the
// product instead of a generic 3D model. Pure CSS (no external 3D / WASM deps),
// so it always renders crisp and bright.
...
const TILT = { transform: 'perspective(1500px) rotateY(-14deg) rotateX(6deg)' } as const;
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center">
      ...
      <div className="vault-float relative w-[min(440px,94%)]">
        ...
        <div
          style={TILT}
          className="relative rounded-[22px] border border-white/12 bg-white/[0.05] p-5 shadow-[0_45px_120px_-30px_rgba(0,0,0,0.95)] backdrop-blur-xl"
        >
          {/* top sheen */}
        ...
        {/* floating accent: generator chip */}
        <div
          style={TILT}
